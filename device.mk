...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/dp_audio_policy_configuration.xml:$(TARGET_COPY_OUT_VENDOR)/etc/dp_audio_policy_configuration.xml \
    $(LOCAL_PATH)/configs/audio/r_submix_audio_policy_configuration.xml:$(TARGET_COPY_OUT_VENDOR)/etc/r_submix_audio_policy_configuration.xml \
    $(LOCAL_PATH)/configs/audio/r_virtual_audio_policy_configuration.xml:$(TARGET_COPY_OUT_VENDOR)/etc/r_virtual_audio_policy_configuration.xml \
...
# Inherit vendor
$(call inherit-product, vendor/huawei/generic_a15/generic_a15-vendor.mk)